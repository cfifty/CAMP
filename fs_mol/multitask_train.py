...
python fs_mol/multitask_train.py ../fsmol_datasets/ --use_embedding True --save-dir 100_epoch_large_dataset_embedding_training_runs

2. To test a pre-trained model:
python fs_mol/multitask_test.py outputs/FSMol_Multitask_2022-11-07_00-05-53/best_model.pt ../fsmol_datasets/ --use_embedding True

3. To train on the smaller dataset:
python fs_mol/multitask_train.py ../small_fsmol_datasets/ --use_embedding True

****without pre-trained embedding model**** (i.e. learn its own embeddings).
1. To train on entire dataset:
python fs_mol/multitask_train.py ../fsmol_datasets/ --save-dir training_runs 
"""
...
def main():
    ...
    if args.use_embedding:
        ...
        MODEL_PATH = '../binding_models/large_dataset_embedding_model_100_epochs.pkl'
