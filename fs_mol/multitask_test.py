...
"""
Don't forget to change large embedding MODEL_PATH! 

To test with large dataset.
python fs_mol/multitask_test.py 100_epoch_large_dataset_embedding_training_runs/FSMol_Multitask_2022-12-08_22-51-51/best_model.pt \
../fsmol_datasets/ --use_embedding True --save-dir 100_epoch_large_dataset_embedding_training_runs
