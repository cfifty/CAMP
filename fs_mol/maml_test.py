...
python fs_mol/maml_test.py ../fsmol_datasets/ --trained-model training_runs/FSMol_MAML_2022-12-30_14-27-00/best_validation.pkl --save-dir training_runs

To test ***WITH*** embeddings:
FSMol_Eval_MAML_2023-01-12_20-50-07 corresponds to the one trained earlier (shorter train log).
python fs_mol/maml_test.py ../fsmol_embedded_datasets/ --trained-model large_dataset_embedding_training_runs/FSMol_MAML_2023-01-06_10-18-24/best_validation.pkl --save-dir large_dataset_embedding_training_runs


FSMol_Eval_MAML_2023-01-12_20-49-07 corresponds to the one trained later (large train log).
python fs_mol/maml_test.py ../fsmol_embedded_datasets/ --trained-model large_dataset_embedding_training_runs/FSMol_MAML_2023-01-09_01-27-26/best_validation.pkl --save-dir large_dataset_embedding_training_runs

To test ***WITH*** embeddings init_proj maintained:
python fs_mol/maml_test.py ../fsmol_embedded_datasets/ --trained-model large_embedding_with_init_proj/FSMol_MAML_2023-01-09_01-29-36/best_validation.pkl --save-dir large_embedding_with_init_proj
"""
...
def load_model_for_eval(args):
    ...
    data_description.batch_features_shapes['node_features'] = (None, 128)
    model.build(data_description.batch_features_shapes)
    model.layers[-1]._initial_projection_layer = tf.keras.layers.Lambda(lambda x: x)
