...
from multitask_train_loop import (
    train_loop,
    create_optimizer,
)
...
"""
To Train 
1. python multitask_train.py ../massive_simulation_dataset --task-list-file datasets/simulation_data.json --num_epochs 101 --cuda 1 --save-dir multitask_training_runs --num_gnn_layers 10
2. python multitask_train.py ../massive_simulation_dataset --task-list-file datasets/simulation_data.json --num_epochs 101 --cuda 1 --save-dir multitask_training_runs --num_gnn_layers 12
3. python multitask_train.py ../massive_simulation_dataset --task-list-file datasets/simulation_data.json --num_epochs 101 --cuda 1 --save-dir multitask_training_runs --num_gnn_layers 16
4. python multitask_train.py ../massive_simulation_dataset --task-list-file datasets/simulation_data.json --num_epochs 101 --cuda 4 --save-dir multitask_training_runs --num_gnn_layers 20

To Test
python multitask_train.py ../xsmall_simulation_dataset --task-list-file datasets/simulation_data.json --num_epochs 101 --cuda 1 --save-dir multitask_training_runs --num_gnn_layers 10
...
def main():
    ...
    save_name = f'{args.learning_rate}_{args.batch_size}_{args.num_gnn_layers}'
